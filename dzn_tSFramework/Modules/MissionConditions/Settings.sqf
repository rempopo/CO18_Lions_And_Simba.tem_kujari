...
MissionCondition1 = [ "WIN", {!isNil "HUT1BURNT" && !isNil "HUT2BURNT" && !isNil "Jackpot" && !alive TGT}, "All objectives done" ];
MissionCondition2 = [ "WIN_PART", {!isNil "HUT1BURNT" && !isNil "HUT2BURNT" && !alive TGT}, "All main objectives done" ];
